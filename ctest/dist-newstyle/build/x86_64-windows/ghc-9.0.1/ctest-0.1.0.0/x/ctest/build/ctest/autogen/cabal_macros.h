...
/* package ctest-0.1.0.0 */
#ifndef VERSION_ctest
#define VERSION_ctest "0.1.0.0"
#endif /* VERSION_ctest */
#ifndef MIN_VERSION_ctest
#define MIN_VERSION_ctest(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_ctest */
...
#define CURRENT_COMPONENT_ID "ctest-0.1.0.0-inplace-ctest"
